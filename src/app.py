...
def dashboard():
	...
	if session['role'] == "Logistics Officer":
		...
		session['columns']=[('Transit ID'), ('Asset Tag'), ('Source Facilitiy'), ('Destination Facility'), ('Request Date')]
		...
		ftasks = query(sql,())
		return render_template('dashboard.html',ltasks = blank,ftasks=ftasks)
